...
interface IERC404 is IERC165 {
  ...
  function erc721BalanceOf(address owner_,uint256 serieId) external view returns (uint256);
  ...
  function owned(address owner_,uint256 serieId) external view returns (uint256[] memory);
